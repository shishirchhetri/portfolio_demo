...
import deved from "./assets/wave.png";
...
function App() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <main className="bg-white px-8 md:px-20 lg:px-40 dark:bg-gradient-to-r from-black to-gray-800 dark:transition-colors duration-200 dark:text-white  ">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 ">
            <h2 className="text-5xl py-2 text-teal-600 font-medium md:text-6xl uppercase">
              Spark
            </h2>
        ...
        <section>
          <div>
            <h3 className="text-3xl py-1 capitalize underline ">
              services offered
            </h3>
        ...
        <section>
          ...
          <div className="flex gap-4 flex-wrap lg:flex py-4 sm:flex-none">
            <div className="flex-1 basis-1/3">
              <img src={web1} alt="" />
            </div>
            <div className="sm: flex-1 basis-1/3">
              <img src={web2} alt="" />
            </div>
            <div className="flex-1 basis-1/3">
